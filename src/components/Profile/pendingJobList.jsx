...
class PendingJobList extends Component {
    ...
    render(){
        ...
        <tr key={index} style={{ visibility: (job.disapproveStatus == 1 || job.call == 1)?'collapse':''}} >
            <td>
            ...
            <td className="statusCm" style={{color:'#33b35a'}}> Pending</td>
                    ...
                    <div className="right-resume-edit-wrapper">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb resume-breadcumb-wrapper cmBreadCumb">
                                        ...
                                        <li className="breadcrumb-item active">Pending Job List</li>
                                    </ol>
                                </nav>
                                <div className="row">
...
export default withRouter(PendingJobList);
