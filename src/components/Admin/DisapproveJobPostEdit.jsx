...
class DisapproveJobPostEdit extends Component {
    ...
    submitFormToApi = () => {
        ...
        let job = new Object()
            ...
            axios.put(`/jobs/company/pending/${update_job_id}`, job,{headers: headers}).then( res => {
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col col-lg-10">
                                    ...
                                    <div class="alert alert-danger" role="alert">
                                      { renderHTML(`${this.state.report}`) }
                                    </div>
                                        <div className="card-header">
                                            <h4 className="mb-0">Update Job</h4>
                                        </div>
                                                            ...
                                                            <div className='form-group col-md-3 col-sm-3 col-lg-2'>
                                                                ...
                                                                <div className="input-group">
                                                                    <div className="custom-control custom-radio custom-control-inline">
                                                                        <input type="radio" onChange={this.setValueToState} className="custom-control-input" id="visa_sponsorshop"  checked={this.state.visa_sponsorshop == "Yes"} value='Yes' name="visa_sponsorshop" />
                                                        ...
                                                        <div className="form-row">
                                                            <div className='form-group col-md-6 col-sm-6'>
                                                                ...
                                                                <div className="input-group">
                                                                    ...
                                                                    <textarea name="company_details" value ={ company_details } onChange={this.setValueToState} rows="2" className="form-control" placeholder="Company Details"> {company_details}</textarea>
                                                                </div>
                                                            </div>
                                                            <div className='form-group col-md-6 col-sm-6'>
...
export default withRouter(DisapproveJobPostEdit);