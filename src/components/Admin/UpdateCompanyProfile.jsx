                        ...
                        <Page loader={"bubble-spin"} color={"#4cbb17"} size={10} duration={1}>
                            <div className="container-fluid">
                                <div className="row justify-content-md-center">
                                    ...
                                    {
                        (this.state.company.report ) ? 
                        <div class="alert alert-danger">
                            <strong>Disapproval massage  :  {this.state.company.report} </strong> 
                        </div> :''
                    }
                                                    ...
                                                    <table className="table table-responsive table-striped companyProfileView">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <p><b>Image:</b></p>
                                                                    <img className="img-responsive img-rounded" height="150px" width="150px" src={`http://localhost:5000/public/uploads/company/logo/${this.state.company.logo}`} alt=""/>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table className="table table-responsive table-striped companyProfileView">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <p><b>Image:</b></p>
                                                                    <img className="img-responsive img-rounded" height="150px" width="150px" src={`http://localhost:5000/public/uploads/company/contact/${this.state.company.photo}`} alt=""/>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table className="table table-responsive table-striped companyProfileView">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <p><b>Image:</b></p>
                                                                    <img className="img-responsive img-rounded" height="150px" width="150px" src={`http://localhost:5000/public/uploads/company/contact/${this.state.company.photo2}`} alt=""/>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
...
export default withRouter(UpdateCompanyProfile);