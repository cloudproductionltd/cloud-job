...
import AllDisApprovedUser from '../../Admin/SuperAdminHome/AllDisApprovedUser';
import AllDisApprovedCompany from '../../Admin/SuperAdminHome/AllDisApprovedCompany';

const $ = window.$;


class AllDisapproveApprovedUsersInfoWithTab extends Component {
                                        ...
                                        <div className="tab-card-header mb-3">
                                            <ul className="nav nav-tabs card-header-tabs tab-cmList" id="myTab" role="tablist">
                                                <li className="nav-item">
                                                    <button className="btn btn-success btn-sm" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="One" aria-selected="true"> Disapproved User List </button>
                                                </li>
                                                <li className="nav-item">
                                                    <button className="btn nextStep btn-sm" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two" aria-selected="false"> Disapproved Company List </button>
                                                </li>
                                                {/* <li className="nav-item">
...
export default withRouter(AllDisapproveApprovedUsersInfoWithTab);