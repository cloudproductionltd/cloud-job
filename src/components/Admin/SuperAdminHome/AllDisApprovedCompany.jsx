...
class AllDisApprovedCompany extends Component {
    ...
    render() {
        ...
        const company_list = companies.map((company,index)=>
                    ...
                    <tr key={index} style={{ visibility: company.report === '' ?'collapse':''}}>
                        ...
                        <Link to={`/admin/company/${company._id}`}  data-toggle="tooltip" data-placement="bottom" title="View Profile" className="btn btn-primary btn-xs adminEdIcon"><i className="fas fa-eye"></i></Link>
                        </td>
                    </tr>
        )
                                ...
                                <div className="row">
                                    ...
                                    <div className="card">
                                        <div className="card-header">
                                            <h4>All Disapprove Company list </h4>
                                        </div>
...
export default withRouter(AllDisApprovedCompany);